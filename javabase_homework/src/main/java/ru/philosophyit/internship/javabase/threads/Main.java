...
public class Main {
    ...
    // * У интерфейса ExecutorService нет автоматического завершения работы.
    //   Поэтому если мы не вызовем методы shutdown() или shutdownNow(), ExecutorService будет ждать поступления новых задач. 
    //   Поскольку поток Main ещё не закончил своё выполнение, задачи потока демона тоже будут выполняться.  *
