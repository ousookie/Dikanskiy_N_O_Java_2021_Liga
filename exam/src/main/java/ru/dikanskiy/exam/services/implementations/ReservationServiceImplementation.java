...
public class ReservationServiceImplementation implements ReservationService {
    ...
    public Page<ReservationDTO> findAllPageable(Integer page, Integer reservationCount) {
    ...
    public Page<ReservationDTO> findAllAvailablePageable(Integer page, Integer reservationCount) {
        Pageable pageable = PageRequest.of(page, reservationCount);
        return reservationRepository.findByAvailableTrue(pageable).map(ReservationMapper::toReservationDTO);
    }

    public Page<ReservationDTO> findByPersonUsernamePageable(final String username,
                                                             Integer page,
                                                             Integer reservationCount) {
        Pageable pageable = PageRequest.of(page, reservationCount);
        return reservationRepository.findByPersonUsername(username, pageable).map(ReservationMapper::toReservationDTO);
    }
    ...
    public Reservation confirm(final UUID id) {
        if (reservationRepository.existsById(id) && reservationRepository.getById(id).getPerson() != null) {
