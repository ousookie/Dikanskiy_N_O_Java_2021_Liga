...
public class AdminController {
    ...
    public List<PersonDTO> personList(@RequestParam(name = "page") String page,
        ...
        return personServiceImplementation
                .findAllPageable(Integer.parseInt(page), Integer.parseInt(personCount))
                .getContent();
    }
    ...
    public List<ReservationDTO> reservationPage(@RequestParam(name = "page") String page,
        ...
        return reservationServiceImplementation.findAllPageable(Integer.parseInt(page), Integer.parseInt(reservationCount)).getContent();
    }
